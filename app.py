...
if mode == "Ask about one government":
    ...
    It does not summarize policies for other countries or areas.
    ...
    **most recent policy changes** or updates issued after the last corpus refresh.
    ...
    The model aims to provide clear and accessible explanations, but may simplify complex policy language.
...
if mode == "Ask about one government":
    ...
    st.markdown(
        ...
        <a href="https://www.plumstead-whiteanalytics.ca/" target="_blank">
            ...
            <span style="color:#777;">© 2025 Plumstead-White Analytics.</span>
        </p>
    ...
    **Note:** The app automatically summarizes the most recent content available at the URLs below.
    ...
    st.markdown(
        ...
        📘 **Reports or guidance documents that reflect intent or emerging direction**  
          Documents that, while not formal Cabinet or ministry policy, still influence how public
          institutions govern and deploy AI systems.
